              ...
              <div class="flashdata" data-flashdata="<?=$this->session->flashdata('info'); ?>"></div>
                <div class="card">
                  <div class="card-header">
                    <a href="<?=site_url('/koperasi/add');?>" class="btn btn-primary">Tambah</a>
                  </div>
                    <div class="card-body table-responsive">
                      <div class="container p-3">
                        <table class="table table-hover" id="tblkoperasi">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=site_url('/koperasi/hapus'); ?>" method="post">
          <input type="hidden" name="kodekoperasi" id="id" required>
