                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="jenisreproduksi">Jenis Reproduksi</label>
                        <select name="jenisreproduksi" id="jenisreproduksi" class="form-control">
                    ...
                    <div class="col-md-6">
                      ...
                      <button type="reset" class="btn btn-danger float-right my-3 mx-3">Batal</button>
                      </form>
                    </div>
                  </div>
                </div>
