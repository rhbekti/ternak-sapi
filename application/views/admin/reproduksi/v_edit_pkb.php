                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= site_url('/Pkb/update'); ?>" method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="hidden" name="idpkb" value="<?=$rw->idpkb;?>">
                                            ...
                                            <div class="input-group date" id="tglform" data-target-input="nearest">
                                                ...
                                                <input type="text" name="tanggal" value="<?=$rw->tanggal;?>" class="form-control datetimepicker-input" data-target="#tglform" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="petugas">Petugas</label>
                                            <input type="hidden" name="idpetugas" value="<?=$rw->kdpetugas;?>">
                                            <input type="text" name="petugas" id="petugas" class="form-control" value="<?=$rw->nama;?>">
                                            <input type="hidden" name="idpetugas">
                                        </div>
                                        <div class="form-group">
                                            <label for="namasapi">Nama Sapi Betina</label>
                                            <div class="input-group">
                                                <input type="hidden" name="idsapi" value="<?=$rw->kdsapi;?>">
                                                <input type="text" class="form-control" id="namasapi" value="<?=$rw->namasapi;?>" name="namasapi" autocomplete="off">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="hasil" id="hasil" class="form-control">
                                                <option value="P" <?=($rw->hasil == 'P')?('selected'):('');?>>Positif</option>
                                                <option value="N" <?=($rw->hasil == 'N')?('selected'):('');?>>Negatif</option>
                                                <option value="Dubius" <?=($rw->hasil == 'Dubius')?('selected'):('');?>>Dubius</option>
                                            </select>
                                            <input type="hidden" name="idib" value="<?=$rw->idib;?>">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-success float-right my-3">Perbarui</button>
